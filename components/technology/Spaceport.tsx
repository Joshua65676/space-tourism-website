    ...
    <section className="">
      <main className="xl:flex xl:flex-row md:flex-col-reverse md:flex lg:flex-col-reverse lg:flex container max-w-6xl mx-auto w-full xl:pt-10 md:pt-20 lg:pt-20 ">
        ...
        <div className="xl:-mt-5 xl:pl-10">
          ...
          <Image src={spaceportMobile} alt="" className="xm:w-[608px] xm:h-[460px] xm:flex mx:w-[608px] mx:h-[460px] mx:flex sm:w-[608px] sm:h-[460px] sm:flex xl:hidden lg:hidden md:hidden mix-blend-screen" />
        </div>
      </main>
    </section>
  );
