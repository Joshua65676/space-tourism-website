...
import { spaceportTablet, spaceportDesktop } from "../../public/assets";
    ...
    <section className="">
      <main className="xl:flex xl:flex-row md:flex-col-reverse md:flex lg:flex-col-reverse lg:flex container max-w-6xl mx-auto w-full xl:pt-10 md:pt-20 lg:pt-20 ">
        ...
        <div className="xl:-mt-5 xl:pl-10">
          <Image src={spaceportTablet} alt="" className="xl:hidden lg:flex lg:w-[900px] lg:h-[400px] md:flex md:w-[900px] md:h-[400px] mix-blend-screen" />
          <Image src={spaceportDesktop} alt="" className="xl:w-[608px] xl:h-[460px] xl:flex lg:hidden md:hidden mix-blend-screen" />
        </div>
      </main>
    </section>
  );
