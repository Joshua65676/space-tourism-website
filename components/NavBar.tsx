      ...
      <nav className="flex justify-between p-10 text-center">
        ...
        <div className="xl:w-[736px] xl:h-[96px] xl:bg-slate-5 xl:-mr-[5.5rem] xl:-mt-3 md:-mt-3 lg:-mt-5 xl:flex md:flex sm:hidden xm:hidden mx:hidden">
           <ul className="flex p-10 space-x-10 ml-10">
            <li>
              <Link href="/" className="text-white">00 <span className="text-sm">Home</span>
              </Link>
            </li>
            <li>
              <Link href="/destination" className="text-white">01 <span className="text-sm">Destination</span>
              </Link>
            </li>
            <li>
              <Link href="/crew" className="text-white">02 <span className="text-sm">Crew</span>
              </Link>
            </li>
            <li>
              <Link href="/technology" className="text-white">03 <span className="text-sm">Technology</span>
              </Link>
            </li>
           </ul>
        </div>
