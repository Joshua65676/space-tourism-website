...
export default function Home() {
  return (
    <div className="xl:bg-Home-Desktop xl:bg-center xl:h-screen xl:bg-cover md:bg-Home-Tablet md:bg-center md:h-screen md:bg-cover sm:bg-Home-Moblie sm:bg-center sm:h-max sm:bg-cover xm:bg-Home-Moblie xm:bg-center xm:h-[1000px] xm:bg-cover mx:bg-Home-Moblie mx:bg-center mx:h-[1000px] mx:bg-cover lg:bg-Home-Tablet lg:bg-center lg:h-screen lg:bg-cover">
      ...
      <div className=" xl:p-28 xl:w-[1110px] xl:h-[343px] xl:flex md:text-center lg:text-center sm:text-center xm:text-center mx:text-center md:p-10 md:mt-20 lg:mt-10 lg:p-5 md:w-[768px] lg:w-[768px] sm:w-[327px] sm:h-[294px] xm:w-[327px] xm:h-[294px]  mx:w-[327px] mx:h-[294px] sm:-ml-12">
        {/* headline and paragraphs */}
        <div className="xl:w-[5430px] xl:h-[343px] md:w-[512px] lg:w-[512px] md:h-[334px] lg:h-[334px] xl:ml-0 md:ml-48 lg:ml-64 sm:ml-[90px] xm:ml-[110px] mx:ml-[90px]">
          {/* headline */}
        ...
        <div className="w-[320px] xl:p-8 md:p-6 h-[320px] xl:ml-64  lg:ml-72 md:ml-64 mx:ml-20 mx:mt-20 sm:ml-20 sm:mt-20 xm:ml-24 xm:mt-20 xl:mt-0 lg:mt-0 md:mt-0 hover:shadow-lg hover:rounded-full hover:bg-white/10 backdrop-blur-0">
